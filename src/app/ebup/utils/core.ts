...
const _URL = typeof URL != "undefined" ? URL : (typeof window != "undefined" ? (window.URL || window.webkitURL) : undefined);
 ...
 * @memberof Core
 */
export function defaults(obj, obj2) {
 ...
 * @memberof Core
 */
export function locationOf(item, array, compareFunction, _start = null, _end = null) {
	var start = _start || 0;
 ...
 * @memberof Core
 */
export function parse(markup, mime, forceXMLDom = false) {
	var doc;
	var Parser;
...
export function treeWalker(root, func, filter) {
	var treeWalker = document.createTreeWalker(root, null, filter);
	let node;
...
export class RangeObject {
	...
	_commonAncestorContainer(startContainer = null, endContainer = null) {
