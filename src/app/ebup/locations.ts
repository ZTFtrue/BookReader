...
class Locations {
	...
	locationFromCfi(cfi) {
		...
		loc = locationOf(cfi, this._locations, this.epubcfi.compare,null,null);
	...
	cfiFromPercentage(percentage) {
		...
		if (percentage >= 1) {
			let cfi = new EpubCFI(this._locations[this.total],null);
			cfi.collapse();
			return cfi.toString();
		}
	...
	setCurrent(curr) {
		...
		this.emitter.emit(EVENTS.LOCATIONS.CHANGED, {
