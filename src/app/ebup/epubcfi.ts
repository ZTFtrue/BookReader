...
class EpubCFI {
	...
	constructor(cfiFrom = null, base = null, ignoreClass = null) {
		var type;
		base = base || {}
		this.str = "";
	...
	compare(cfiOne, cfiTwo) {
		...
		if (typeof cfiOne === "string") {
			cfiOne = new EpubCFI(cfiOne, null, null);
		}
		if (typeof cfiTwo === "string") {
			cfiTwo = new EpubCFI(cfiTwo, null, null);
		}
	...
	position(anchor) {
		...
		if (anchor.nodeType === ELEMENT_NODE) {
			...
			children = this.textNodes(anchor.parentNode, null);
	...
	*/
	...
	findNode(steps, _doc, ignoreClass) {
		...
		if (!ignoreClass && typeof doc.evaluate != "undefined") {
			...
			container = this.walkToNode(steps, doc, null);
		}
